...
if __name__=='__main__':
    ...
    a=agent(m,5,1,goal=(2,4),footprints=True,color=COLOR.SEARCH,shape='square',filled=True)
    b=agent(m,2,4,goal=(5,1),footprints=True,filled=True, color=COLOR.PARENT)
    c=agent(m,5,1,footprints=True,color=COLOR.PATH)
